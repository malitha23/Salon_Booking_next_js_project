...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2024 at 08:01 PM
...
--
ALTER TABLE `bookings`
  ADD CONSTRAINT `bookings_ibfk_2` FOREIGN KEY (`event_id`) REFERENCES `saloons` (`id`);
COMMIT;
